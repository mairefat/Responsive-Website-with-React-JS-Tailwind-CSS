...
const Navbar = () => {
  ...
  return (
    ...
    >
      <img src={logo} alt="hoobank" className="w-[124px] h-[32px] border-[0.1px] border-transparent
...
flex-1"
    ...
    text-white border-[0.1px] border-transparent
    hover:text-secondary rounded-[10px]  cursor-pointer transition duration-600 ease-in-out `}
          >
