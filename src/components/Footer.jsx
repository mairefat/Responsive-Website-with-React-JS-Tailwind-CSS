    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      ...
      flex-col mb-8 w-full`}>
        <div className="flex-1 flex flex-col justify-start mr-10">
          ...
          border-[0.1px] border-transparent
    hover:border-secondary rounded-full cursor-pointer transition duration-600 ease-in-out" />
          <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>
          A new way to make the payments easy, reliable and secure.
          </p>
        </div>
        <div className="flex-[1.5] w-full flex flex-row
        justify-between flex-wrap md:mt-0 scroll-mt-10">
      ...
      items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
        <p className="font-poppins font-normal
              text-center text-[18px] leading-[27px] text-white 
              border-[0.1px] border-transparent
    hover:text-secondary rounded-full cursor-pointer transition duration-600 ease-in-out">
        Copyright @ 2021 HooBank. All Rights Reserved.
        </p>
        <div className="flex flex-row md:mr-0 mr-6">
          {socialMedia.map((social, index) => (
            ...
            border-[0.1px] border-transparent
    hover:border-secondary  cursor-pointer transition duration-600 ease-in-out`} />
          ))}
